  ...
  return (
    <>
      {projects.map((project) => (
        <Card className="bg-gray-100/5 mx-auto mb-10 py-4 w-full sm:w-5/6">
          <CardBody className="flex flex-col sm:flex-row items-center justify-evenly py-2">
            ...
            <div className="w-full sm:w-1/2 flex flex-col items-center justify-center mt-4 sm:mt-0">
              ...
              <a href={project.link} target="_blank">
                <button
                  type="button"
                  class="bg-white text-center w-48 rounded-2xl h-14 relative font-sans text-black my-5 text-xl font-semibold group"
                >
                  ...
                  <p class="translate-x-2 ml-1">Learn More</p>
                </button>
              </a>
            </div>
          </CardBody>
